...
import { ArrowLeft, Search, MapPin, Star, Clock, Heart, Filter } from "lucide-react"
...
export default function RestaurantsPage() {
  ...
  const filteredRestaurants = restaurants.filter((restaurant) => {
    ...
    const matchesTab =
      activeTab === "all" ||
      (activeTab === "recommended" && restaurant.isRecommended) ||
              ...
              {filteredRestaurants.map((restaurant) => (
                ...
                >
                  <div className="relative">
                    ...
                    {restaurant.isRecommended && <Badge className="absolute top-2 left-2">추천</Badge>}
                  </div>
